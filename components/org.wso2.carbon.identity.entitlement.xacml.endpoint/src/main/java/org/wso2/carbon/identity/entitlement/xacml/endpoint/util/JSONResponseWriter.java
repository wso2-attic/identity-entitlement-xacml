...
public class JSONResponseWriter {
     ...
     */
    public static JsonObject write(ResponseCtx response) throws EntitlementServiceException {
        ...
        if (response.getResults().size() < 1) {
            throw new EntitlementServiceException(40032, "XACML response should contain at least 1 Result");
        }
     ...
     * @throws EntitlementServiceException <code>{@link EntitlementServiceException}</code>
     */
    private static JsonObject abstractResultToJSONObject(AbstractResult result) throws EntitlementServiceException {
        JsonObject jsonResult = new JsonObject();

        //Decision property is mandatory, if not set throw error
        if (result.getDecision() == -1) {
            throw new EntitlementServiceException(40031, "XACML Result should contain the Decision");
        }
    ...
    /**
     * Private method to convert a given Balana <code>{@link AttributeAssignment}</code> to
     * <code>{@link JsonObject}</code>
     *

...
package org.wso2.carbon.identity.entitlement.xacml.endpoint.util;
...
public class JSONRequestParser {
     ...
     * @throws EntitlementServiceException      <code>{@link EntitlementServiceException}</code>
     * @throws UnknownIdentifierException <code>{@link UnknownIdentifierException}</code>
     */
    public static RequestCtx parse(String jsonRequest) throws JsonParseException, EntitlementServiceException,
                ...
                switch (jsonAttribute.getKey()) {
                        ...
                        if (jsonCategory.has(EntitlementEndpointConstants.CONTENT)) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    throw new JsonParseException("DOM of request element " +
                                            "can not be created from String");
                                }
                            }
                            if (doc != null) {
                                content = doc;
                    ...
                    case EntitlementEndpointConstants.MULTI_REQUESTS:
                        ...
                        if (jsonRequestReferences.isEmpty()) {
                            throw new EntitlementServiceException(40020, "MultiRequest should contain at least one " +
                                    "Reference Request");
                        }
     ...
     */
    private static Attribute jsonObjectToAttribute(JsonObject jsonObject) throws EntitlementServiceException,
            UnknownIdentifierException {
        URI id = null;
        ...
        if (id == null) {
            throw new EntitlementServiceException(40020, "Attribute Id should be set");
        }

        if (attributeValues.isEmpty()) {
            throw new EntitlementServiceException(40020, "Attribute should have at least one value");
        }
    ...
    /**
     * Private method to convert a given <code>{@link JsonObject}</code>
     * to a Balana <code>{@link RequestReference}</code>
     *
    ...
    private static RequestReference jsonObjectToRequestReference(JsonObject jsonRequestReference) {
        ...
        if (jsonRequestReference.has(EntitlementEndpointConstants.REFERENCE_ID)) {
            JsonArray referenceIds = jsonRequestReference.get(EntitlementEndpointConstants.REFERENCE_ID)
                    .getAsJsonArray();
     ...
     * @throws EntitlementServiceException
     */
    private static String stringContentToXMLContent(String content) throws EntitlementServiceException {
